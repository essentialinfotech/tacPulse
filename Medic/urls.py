...
urlpatterns = [
    ...
    path('ambulance/task/complete/<hashid:pk>/', ambulance_task_complete, name='ambulance_task_complete'),
    ...
    path('panic/task/comlete/<hashid:pk>/', complete_panic_task, name='complete_panic_task'),
